...
class RetainedTextKeyTest {
    @Test void equalValuesAreEqualAndEveryFieldAffectsEquality() {
    ...
    @Test void inputListIsDefensivelyCopied() {
    ...
    private static RetainedTextKey<String> key(List<String> glyphs, float x, float y, int color,
                                                boolean shadow, boolean bidi, int background, int variant, long generation) {
