...
public final class DifferentialFixtureRegistry {
    ...
    private static LinkedHashMap<String, Fixture> build() {
        ...
        add(
                ...
                "entity_solid",
                Phase.BASELINE,
                "Vanilla wide-player opaque body",
                ModelLayers.PLAYER,
                STEVE,
                Material.ENTITY_SOLID,
                false,
                times(0),
                cameras(0),
        ...
        add(
                ...
                ModelLayers.BAT,
                id("textures/entity/bat/bat.png"),
                Material.ENTITY_CUTOUT_CULL,
                false,
                times(0),
                cameras(0, 180),
                TargetContract.COLOR_DEPTH);
        add(
                ...
                "entity_cutout",
                Phase.A,
                "Temperate cow ordinary living model",
                ModelLayers.COW,
                id("textures/entity/cow/cow_temperate.png"),
                Material.ENTITY_CUTOUT,
                false,
                times(0),
                cameras(0, 180),
                TargetContract.COLOR_DEPTH);
        add(
                ...
                "entity_cutout_z_offset",
                Phase.A,
                "Shulker view-offset shell",
                ModelLayers.SHULKER,
                id("textures/entity/shulker/shulker.png"),
                Material.ENTITY_CUTOUT_Z_OFFSET,
                false,
                times(0),
                cameras(0),
                TargetContract.COLOR_DEPTH);
        add(
                ...
                "armor_cutout",
                Phase.A,
                "Iron humanoid chest armor",
                ModelLayers.PLAYER_ARMOR.chest(),
                id("textures/entity/equipment/humanoid/iron.png"),
                Material.ARMOR_CUTOUT,
                false,
                times(0),
                cameras(0),
                TargetContract.COLOR_DEPTH);
        add(
                ...
                "armor_decal",
                Phase.A,
                "Sentry iron armor trim decal",
                ModelLayers.PLAYER_ARMOR.chest(),
                ARMOR_TRIM_ATLAS,
                List.of(
                        id("textures/entity/equipment/humanoid/iron.png"),
                        id("textures/trims/entity/humanoid/sentry.png")),
                Material.ARMOR_DECAL,
                false,
                times(0),
                cameras(0),
                TargetContract.COLOR_DEPTH);
        ...
        add(
                ...
                "entity_translucent_cull",
                Phase.B,
                "Culled translucent slime shell",
                ModelLayers.SLIME_OUTER,
                id("textures/entity/slime/slime.png"),
                Material.ENTITY_TRANSLUCENT_CULL,
                true,
                times(0),
                cameras(0, 180),
                TargetContract.COLOR_DEPTH);
        add(
                ...
                "entity_translucent_emissive",
                Phase.B,
                "Warden bioluminescent mask",
                ModelLayers.WARDEN_BIOLUMINESCENT,
                id("textures/entity/warden/warden_bioluminescent_layer.png"),
                Material.ENTITY_TRANSLUCENT_EMISSIVE,
                true,
                times(0),
                cameras(0, 180),
                TargetContract.COLOR_DEPTH);
        add(
                ...
                "armor_translucent",
                Phase.B,
                "Damaged wolf armor body",
                ModelLayers.WOLF_ARMOR,
                id("textures/entity/equipment/wolf_body/armadillo_scute.png"),
                Material.ARMOR_TRANSLUCENT,
                true,
                times(0),
                cameras(0, 180),
                TargetContract.COLOR_DEPTH);
        add(
                ...
                "banner_pattern",
                Phase.B,
                "Standing banner base-pattern atlas sprite",
                ModelLayers.STANDING_BANNER_FLAG,
                BANNER_ATLAS,
                List.of(id("textures/entity/banner/base.png")),
                Material.BANNER_PATTERN,
                true,
                times(0),
                cameras(0, 180),
                TargetContract.COLOR_DEPTH);
        add(
                ...
                "eyes",
                Phase.B,
                "Spider emissive eyes mask",
                ModelLayers.SPIDER,
                id("textures/entity/spider/spider_eyes.png"),
                Material.EYES,
                true,
                times(0),
                cameras(0, 180),
        ...
        add(
                ...
                ModelLayers.CHEST,
                id("textures/block/destroy_stage_3.png"),
                Material.CRUMBLING,
                true,
                times(0),
                cameras(0, 90),
        ...
        add(
                ...
                "entity_cutout_dissolve",
                Phase.C,
                "Ender Dragon dissolve mask",
                ModelLayers.ENDER_DRAGON,
                DRAGON,
                List.of(DRAGON_DISSOLVE),
                Material.ENTITY_CUTOUT_DISSOLVE,
                false,
                times(0, .5f, .9f),
                cameras(0),
                TargetContract.COLOR_DEPTH);
        add(
                ...
                "breeze_wind",
                Phase.C,
                "Breeze wind animated layer",
                ModelLayers.BREEZE_WIND,
                id("textures/entity/breeze/breeze_wind.png"),
                Material.BREEZE_WIND,
                true,
                times(0, .25f, .5f, .75f),
                cameras(0, 180),
                TargetContract.COLOR_DEPTH);
        add(
                ...
                "energy_swirl",
                Phase.C,
                "Charged Creeper animated armor",
                ModelLayers.CREEPER_ARMOR,
                id("textures/entity/creeper/creeper_armor.png"),
                Material.ENERGY_SWIRL,
                true,
                times(0, .25f, .5f, .75f),
                cameras(0, 180),
                TargetContract.COLOR_DEPTH);
        add(
                ...
                ModelLayers.PLAYER_ARMOR.chest(),
                id("textures/misc/enchanted_glint_armor.png"),
                Material.GLINT,
                false,
                times(0, .25f, .5f, .75f),
                cameras(0),
        ...
        add(
                ...
                "water_mask",
                Phase.C,
                "Oak boat water patch",
                ModelLayers.BOAT_WATER_PATCH,
                null,
                Material.WATER_MASK,
                false,
                times(0),
