...
public record TranslucentPhaseSnapshot(long generation, int phaseSlot, long pipelineEpoch, DetachedTranslucentSnapshot data) {
    public TranslucentPhaseSnapshot(long generation, int phaseSlot, long pipelineEpoch, SubmitNode[] submits, float[] distances) {
