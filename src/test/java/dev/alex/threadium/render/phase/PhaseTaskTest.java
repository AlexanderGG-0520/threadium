...
class PhaseTaskTest {
    @Test
    void asyncResultCanMergeOnlyOnce() {
    ...
    @Test
    void wrongGenerationCannotMerge() {
    ...
    @Test
    void fallbackMakesLateWorkerCompletionStale() throws Exception {
    ...
    @Test
    void failureRemainsRecoverableByFallback() {
        PhaseTask<Integer, Integer> task = task(1, value -> {
    ...
    @Test
    void cancellationBeforeExecutionDoesNotRunProcessor() {
        boolean[] ran = {false};
        PhaseTask<Integer, Integer> task = task(1, value -> {
            ran[0] = true;
            return value;
    ...
    @Test
    void sharedAbsoluteDeadlineDoesNotRenewPerWait() throws Exception {
