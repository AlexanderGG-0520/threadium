#version 330 core
uniform sampler2D Sampler0; uniform sampler2D Sampler1; uniform sampler2D Sampler2;
uniform int uDebugMode;
in vec2 vUv; in vec3 vNormal; flat in int vLight; flat in int vOverlay; in vec4 vTint; out vec4 outColor;
