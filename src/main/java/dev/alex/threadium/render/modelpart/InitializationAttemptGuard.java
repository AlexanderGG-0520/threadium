...
public final class InitializationAttemptGuard {
    ...
    public boolean beginAttempt() { return attempted.compareAndSet(false,true); }
    public boolean attempted() { return attempted.get(); }
    public void reset() { attempted.set(false); }
}
